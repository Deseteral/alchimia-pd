...
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local Ingredient = Ingredient or ({})
Ingredient.HERB = 0
Ingredient[Ingredient.HERB] = "HERB"
Ingredient.MUSHROOM = 1
Ingredient[Ingredient.MUSHROOM] = "MUSHROOM"
Ingredient.STONE = 2
Ingredient[Ingredient.STONE] = "STONE"
Ingredient.GOLD = 3
Ingredient[Ingredient.GOLD] = "GOLD"
Ingredient.FLOWER = 4
Ingredient[Ingredient.FLOWER] = "FLOWER"
local Ingredients = {
    Ingredient.HERB,
    Ingredient.MUSHROOM,
    Ingredient.STONE,
...
local IngredientAction = IngredientAction or ({})
IngredientAction.CUTTING = 0
IngredientAction[IngredientAction.CUTTING] = "CUTTING"
IngredientAction.GRIDING = 1
IngredientAction[IngredientAction.GRIDING] = "GRIDING"
IngredientAction.BURNING = 2
IngredientAction[IngredientAction.BURNING] = "BURNING"
IngredientAction.ENCHANTING = 3
IngredientAction[IngredientAction.ENCHANTING] = "ENCHANTING"
local IngredientActions = {IngredientAction.CUTTING, IngredientAction.GRIDING, IngredientAction.BURNING, IngredientAction.ENCHANTING}
local function ingredientDisplayName(self, ingredient)
    repeat
...
____exports.Ingredient = Ingredient
____exports.Ingredients = Ingredients
____exports.IngredientAction = IngredientAction
____exports.IngredientActions = IngredientActions
____exports.ingredientDisplayName = ingredientDisplayName
return ____exports
 end,
["game.message-board"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
return ____exports
 end,
["game.recipe-logic"] = function(...) 
local ____lualib = require("lualib_bundle")
local __TS__ArrayFindIndex = ____lualib.__TS__ArrayFindIndex
local __TS__ArrayEvery = ____lualib.__TS__ArrayEvery
local __TS__ArrayFind = ____lualib.__TS__ArrayFind
local ____exports = {}
local function preparedIngredientEquals(self, pi1, pi2)
    return pi1.ingredient == pi2.ingredient and pi1.action == pi2.action
end
local function doesListContainPreparedIngredient(self, pi, pl)
    return __TS__ArrayFindIndex(
        pl,
        function(____, pii) return preparedIngredientEquals(nil, pi, pii) end
    ) >= 0
end
local function preparedIngredientListEquals(self, pl1, pl2)
    if #pl1 ~= #pl2 then
        return false
    end
    local c1 = __TS__ArrayEvery(
        pl1,
        function(____, pi1) return doesListContainPreparedIngredient(nil, pi1, pl2) end
    )
    local c2 = __TS__ArrayEvery(
        pl2,
        function(____, pi2) return doesListContainPreparedIngredient(nil, pi2, pl1) end
    )
    return c1 and c2
end
local function findMatchingRecipe(self, pl, list)
    return __TS__ArrayFind(
        list,
        function(____, r) return preparedIngredientListEquals(nil, r.ingredients, pl) end
    ) or nil
end
____exports.preparedIngredientEquals = preparedIngredientEquals
____exports.doesListContainPreparedIngredient = doesListContainPreparedIngredient
____exports.preparedIngredientListEquals = preparedIngredientListEquals
____exports.findMatchingRecipe = findMatchingRecipe
return ____exports
 end,
["game.potion-names"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local POTION_NAMES = {
    "Sassafras",
...
____exports.POTION_NAMES = POTION_NAMES
return ____exports
 end,
["game.utils"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local function clamp(self, num, min, max)
    return math.min(
        math.max(num, min),
        max
    )
end
local function randomRange(self, min, max)
    return math.floor(math.random() * (max - min + 1) + min)
end
____exports.clamp = clamp
____exports.randomRange = randomRange
return ____exports
 end,
["game.recipes"] = function(...) 
local ____lualib = require("lualib_bundle")
local __TS__ArrayFindIndex = ____lualib.__TS__ArrayFindIndex
local __TS__ArraySplice = ____lualib.__TS__ArraySplice
local ____exports = {}
local ____ingredients = require("game.ingredients")
local IngredientActions = ____ingredients.IngredientActions
local Ingredients = ____ingredients.Ingredients
local ____recipe_2Dlogic = require("game.recipe-logic")
local findMatchingRecipe = ____recipe_2Dlogic.findMatchingRecipe
local preparedIngredientEquals = ____recipe_2Dlogic.preparedIngredientEquals
local ____potion_2Dnames = require("game.potion-names")
local POTION_NAMES = ____potion_2Dnames.POTION_NAMES
local ____utils = require("game.utils")
local randomRange = ____utils.randomRange
local function generateRecipes(self)
    local recipes = {}
...
____exports.generateRecipes = generateRecipes
return ____exports
 end,
["game.game-state"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
return ____exports
 end,
...
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local ____recipes = require("game.recipes")
local generateRecipes = ____recipes.generateRecipes
import("CoreLibs/object")
